  ...
  return (
    <Card className={cn("max-w-3xl w-full py-6 bg-card/35", props.className)}>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-2 border border-destructive px-3 py-1.5 text-xs font-medium text-destructive uppercase tracking-wide">
          <span className="size-2 rounded-full bg-destructive animate-blink" />
          Live results
        </div>
      </CardHeader>
